...
function HomeCard({product}) {
  return (
    <div className='cursor-pointer flex flex-col items-center justify-center bg-white rounded-lg shadow-neutral-50 shadow-md hover:shadow-lg transition-all duration-300 ease-in-out p-4 border-2 border-gray-100 m-2 '>
