        ...
        <div className="flex flex-col items-center">
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">	
            <div className="lg:col-span-2 ">
              <h1 className="text-lg lg:text-xl font-semibold tracking-tight text-gray-900 ">Universaloutfit</h1>
              <h1 className="text-lg lg:text-xl font-semibold tracking-tight text-gray-900 opacity-60">sfcschbavxgasvxjac</h1>
            </div>
        ...
        <section className='w-[100vw]'>
          ...
          <div className='border border-gray-300 p-5 '>
            <Grid container spacing={7}>
              ...
              <Grid item xs={5} className='ml-200'>
